...
func TestListOfRoutes(t *testing.T) {
	...
	assertRoutePresent(t, list, RouteInfo{
		...
		Path:    "/favicon.ico",
		Handler: "^(.*/vendor/)?github.com/pckhoi/gin.handlerTest1$",
	})
	assertRoutePresent(t, list, RouteInfo{
		Method:  http.MethodGet,
		Path:    "/",
	...
	assertRoutePresent(t, list, RouteInfo{
		Method:  http.MethodGet,
		Path:    "/users/",
		Handler: "^(.*/vendor/)?github.com/pckhoi/gin.handlerTest2$",
	})
	assertRoutePresent(t, list, RouteInfo{
		Method:  http.MethodGet,
		Path:    "/users/:id",
...
func TestNewOptionFunc(t *testing.T) {
	...
	routes := r.Routes()
	assertRoutePresent(t, routes, RouteInfo{Path: "/test1", Method: http.MethodGet, Handler: "github.com/pckhoi/gin.handlerTest1"})
	assertRoutePresent(t, routes, RouteInfo{Path: "/test2", Method: http.MethodGet, Handler: "github.com/pckhoi/gin.handlerTest2"})
}
...
// Test the fix for https://github.com/pckhoi/gin/issues/4002
