...
[![Build Status](https://github.com/pckhoi/gin/workflows/Run%20Tests/badge.svg?branch=master)](https://github.com/pckhoi/gin/actions?query=branch%3Amaster)
[![codecov](https://codecov.io/gh/gin-gonic/gin/branch/master/graph/badge.svg)](https://codecov.io/gh/gin-gonic/gin)
[![Go Report Card](https://goreportcard.com/badge/github.com/pckhoi/gin)](https://goreportcard.com/report/github.com/pckhoi/gin)
[![Go Reference](https://pkg.go.dev/badge/github.com/pckhoi/gin?status.svg)](https://pkg.go.dev/github.com/pckhoi/gin?tab=doc)
[![Sourcegraph](https://sourcegraph.com/github.com/pckhoi/gin/-/badge.svg)](https://sourcegraph.com/github.com/pckhoi/gin?badge)
[![Open Source Helpers](https://www.codetriage.com/pckhoi/gin/badges/users.svg)](https://www.codetriage.com/pckhoi/gin)
[![Release](https://img.shields.io/github/release/gin-gonic/gin.svg?style=flat-square)](https://github.com/pckhoi/gin/releases)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/pckhoi/gin)](https://www.tickgit.com/browse?repo=github.com/pckhoi/gin)
...
```sh
import "github.com/pckhoi/gin"
```

Alternatively, use `go get`:

```sh
go get -u github.com/pckhoi/gin
```
...
See the [API documentation on go.dev](https://pkg.go.dev/github.com/pckhoi/gin).
...
Here are some awesome projects that are using the [Gin](https://github.com/pckhoi/gin) web framework.
